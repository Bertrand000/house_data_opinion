...
class TengxunHouse():
    ...
    # 默认等待时间
    sleep_time = 0.3
    header_url = "http://house.people.com.cn/"
    # 评论接口模板
    discuss_url_temp = "http://bbs1.people.com.cn/post/129/1/2/172203560.html"
    # 初始url
    index_url = "http://bbs1.people.com.cn/post/129/1/2/172203560.html"
    headers = {
